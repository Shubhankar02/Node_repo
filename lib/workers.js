...
workers.processCheckOutcome = function (originalCheckData, checkOutCome) {
    ...
    const alertWarranted = originalCheckData.lastChecked && originalCheckData.status !== state ? true : false;
...
workers.alertUserToStatusChange = function(newCheckData) {
    ...
    helpers.sendTwilioSms(newCheckData.userPhone, msg, (err) => {
        if(!err) {
            ...
            console.log('Error: Could not send the SMS alert to the user who has change in their state', err);
        }
    })
};
